...
| `landing_pages` | free | Zone-based landing page builder scoped per site: 20+ zone types with DaisyUI templates and 90+ seed presets, testimonials with Schema.org markup, order/contact form submissions with Turnstile + rate limiting, and cached slug resolution. Requires `multi_domain` (apps.sites). See `plugins/landing_pages/README.md`. |
