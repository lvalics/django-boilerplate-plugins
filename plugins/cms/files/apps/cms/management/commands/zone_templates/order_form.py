...
ORDER_FORM_TEMPLATES = [
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    {
        ...
        "template_file": "cms/zones/order_form.html",
        "is_active": True,
        "description": """TEMPLATE: cms/zones/order_form.html
...
""",
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    {
        ...
        "zone_type": ZoneType.ORDER_FORM,
        "template_file": "cms/zones/order_form_floating.html",
        "is_active": True,
        "description": """TEMPLATE: cms/zones/order_form_floating.html
